-- Un ascolto già salvato non si accorcia se arriva dopo una durata stimata più corta
-- (il browser a volte riporta metà file finché i metadati non sono completi).
