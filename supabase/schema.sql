...
-- Citazioni per l'email di incoraggiamento dopo la pratica del giorno.
-- Solo service role (Edge Function): nessuna policy client.
create table quotes (
  id uuid primary key default gen_random_uuid(),
...
insert into quotes (author, book_title, quote_text, week_theme, language) values
  ('[Autore esempio]', '[Titolo esempio]', '[ESEMPIO — sostituire con citazione reale] La pratica si costruisce un giorno alla volta.', 1, 'it'),
  ('[Autore esempio]', '[Titolo esempio]', '[ESEMPIO — sostituire con citazione reale] Tornare al respiro, ancora, senza fretta.', 1, 'it');
...
-- Iscritti solo da remoto inattivi da 15 giorni, da avvisare una volta per tipo.
